<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="adminbookinventory.aspx.cs" Inherits="newproj.adminbookinventory" %>
            ...
            <div class="card">
               <div class="card-body">
                  <div class="row">
                     <div class="col">
                        <center>
                           <h2 style="text-shadow:2px 2px #D3D3D3">Book Details</h2>
                        </center>
                     </div>
                  </div>
                  <div class="row">
                     <div class="col">
                        <center>
                           <img id="imgview" Height="200" Width="100" src="book_inventory/books1.png" />
                        </center>
                     </div>
                  </div>
                  <div class="row">
                                 ...
                                 <ItemTemplate>
                                    <div class="container-fluid">
                                       <div class="row">
                                          ...
                                          <div class="col-lg-2">
                                             <asp:Image class="img-fluid" Height="150" Width="200" ID="Image1" runat="server" ImageUrl='<%# Eval("book_img_link") %>' />
                                          </div>
                                       </div>
                                    </div>
                                 </ItemTemplate>
