<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="userprofile.aspx.cs" Inherits="newproj.userprofile" %>
            ...
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col">
                        <center>
                           <h3 style="text-shadow:2px 2px #D3D3D3">Your Profile</h3>
                  ...
                  <div class="row">
                     ...
                     <div class="col">
                         <div class="table-responsive">
                             <asp:GridView ID="GridView1" runat="server" Width="100%" CssClass="table table-striped table-bordered " AutoGenerateColumns="false" OnRowDataBound="GridView1_RowDataBound">
                                 <Columns>
