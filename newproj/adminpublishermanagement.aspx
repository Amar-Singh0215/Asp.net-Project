<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="adminpublishermanagement.aspx.cs" Inherits="newproj.adminpublishermanagement" %>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col">
                                <center>
                                        <h2 style="text-shadow:2px 2px #D3D3D3">Publisher Details</h2>
                                    </center>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <asp:GridView class="table table-striped table-bordered" ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="publisher_id" DataSourceID="SqlDataSource1">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="publisher_name" HeaderText="Author Id" SortExpression="publisher_name" />
                                    </Columns>
                                </asp:GridView>
                            </div>
                        </div>
